...
<body>
    <header>
        ...
        <nav>
            <!-- <div style="border:1px solid green;display:flex; align-items:center;justify-contents:center;width:fit-content"> -->
                <h1 style=" font-size:1.5rem; margin-top:8px;">EMS-NBPDCL</h1>
                ...
                <div class="card-body">
                    ...
                    <form action="process/assignp.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <span class="input--style-1">Due Date</span>
