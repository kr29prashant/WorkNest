	...
	<header>
		...
		<img class="logoimg" src="./assets/Logo.png" alt="nbpdllogo">
			...
			<ul id="navli">
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 30px; text-align: center;color: rgb(105, 227, 40);;letter-spacing:0.5;">Empolyee Leaderboard </h2>
...
<h2 style="font-family: 'Montserrat', sans-serif; font-size: 30px; text-align: center;color: rgb(105, 227, 40);letter-spacing:0.5;">Due Projects</h2>
...
<h2 style="font-family: 'Montserrat', sans-serif; font-size: 30px; text-align: center;color: rgb(105, 227, 40);letter-spacing:0.5;">Leave Satus</h2>
